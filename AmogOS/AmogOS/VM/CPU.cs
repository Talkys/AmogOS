...
namespace AmogOS.VM
{
    class CPU
    {
        ...
        public static void Clock()
        {
            if (!IsHalted)
            {
                // resetar pc quando chegar em max
                ...
                if (DebugVisible)
                {
                    // reduzindo a velocidade de escrita pra deixar mais estável
                    Kernel.Delay(Delay);
                }
            }
        ...
        public static void DrawDebug()
        {
            ...
            // reg w
            TextGraphics.DrawString(67, CLI.Height - 1, "W=" + DataUtils.IntToHex(W), Color.Blue, CLI.BackColor);
